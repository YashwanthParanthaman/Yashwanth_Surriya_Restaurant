...
function SignupScreen({navigation}){
  ...
  return(
    ...
    <TextInput style={styles.input} placeholder = "Name"  returnKeyType = "next"  value = {name}  onChangeText = {setName}/>
    ...
    <TextInput style={styles.input} placeholder = "Password" returnKeyType = "next" value = {password} onChangeText = {setPassword} textContentType = "password" autoCapitalize = "none"/>
    ...
    <TextInput style={styles.input} placeholder = "Phone No." returnKeyType = "next" value = {contact} onChangeText = {setContact}textContentType = "telephoneNumber"/>
